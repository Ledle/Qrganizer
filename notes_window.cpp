...
void notes_window::on_Groups_listWidget_itemClicked(QListWidgetItem* item)
{
}
void notes_window::on_Groups_listWidget_itemSelectionChanged()
{
    int currentRow = ui->Groups_listWidget->currentRow();
...
void notes_window::on_Groups_comboBox_textActivated(const QString& arg1)
{
    int index = ui->Groups_comboBox->currentIndex();
